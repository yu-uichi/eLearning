...
?>
<?php
    if(!isset($_POST['pastNum'])){
        header('Location: test_setting_pastQue.php');
    }
?>
...
<?php
    ...
    $dbh = connectDB(); //DB接続
    $number_year_id=$_POST['pastNum']; //時期指定
    $ampm=$_POST['ampm'];//ampm
    $sql = "SELECT * FROM `problem_tb` WHERE number_year_id = " . $number_year_id ." AND ampm = '".$ampm."'";
