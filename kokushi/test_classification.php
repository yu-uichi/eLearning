...
<?php
    if(!isset($_POST['classification'])){
        header('Location: test_setting_classification.php');
    }
?>
...
<?php
    ...
    $dbh = connectDB(); //DB接続
    $classification_id=$_POST['classification']; //分類指定
    $limit = $_POST['numOfQue'];//問題数
    $sql = "SELECT * FROM `problem_tb` WHERE classification_id = " . $classification_id . " ORDER BY RAND() LIMIT ". $limit;
